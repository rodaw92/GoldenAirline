      ...
      <div className="placeorder">
        <div className="placeorder-info">
          <div>
            ...
            <div>
              {order.passengeraddress.address}, {order.passengeraddress.city},
          {order.passengeraddress.postalCode}, {order.passengeraddress.country},
          </div>
            <div>
              {order.isDelivered ? <MessageBox variant="success">Delivered at + {order.deliveredAt}</MessageBox> 
              : (<MessageBox variant="danger">Approved.</MessageBox>)}
            </div>
          </div>
          <div>
            <h3>Payment</h3>
